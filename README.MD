...
Inicialmente foi utilizado a métrica NPS, que é amplamente aplicada no mercado para medir a satisfação dos consumidores. Ela é baseada em apenas uma pergunta: 
